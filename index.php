...
<body>
        ...
        <header>
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-dark">
                    <a class="navbar-brand" href="#home">EcoFrenzy</a>
                ...
                <div class="row">
                    <div class="col-lg-6 align-item-center">
                        <div class="home-info">
                            ...
                            <h2>Every small act counts. Join <span>the waste reduction</span> revolution today.</h2>
                            <p>Be the change you want to see. Start with waste reduction.</p>
                            <div class="buttons">
    ...
    <section class="mission" id="mission-id">
        <div class="container">
            <div class="heading">
                <h2>Our Mission</h2>
                <p>Small changes, <span>big impact.</span> Join the  <span>waste reduction</span> revolution</p>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 order-first order-lg-last">
                    ...
                    <p>We are committed to empowering individuals to make a positive impact on the environment by reducing their waste and increasing their recycling efforts. Our app is designed to be user-friendly and intuitive, allowing users to easily track and reduce their waste, and receive feedback on their progress.</p>
                    <p>In addition, our app provides valuable information on how to recycle items correctly, and offers educational resources and tips for reducing waste, composting, and more. Our community feature allows users to connect with others who are also working towards waste reduction, providing support and encouragement for achieving their goals. Our ultimate goal is to promote sustainable living and protect the environment, and we believe that small changes can make a big impact when it comes to waste reduction.</p>
                </div>
            </div>
        </div>
    </section>
